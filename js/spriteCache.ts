...
export class SpriteCache {
    ...
    createGravitationalSprite(): void {
        const size = this.baseSize;
        const canvas = document.createElement('canvas');
        canvas.width = size;
        canvas.height = size;
    ...
    getSprite(type: string): HTMLCanvasElement | undefined {
...
export function setSimplifiedRendering(value: boolean): void {
