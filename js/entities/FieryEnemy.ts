...
export class FieryEnemy extends BaseEnemy {
    ...
    constructor(x: number, y: number, scaling: any = null) {
        ...
        // Trail settings
        this.trailInterval = (config as any).trailInterval;
        this.trailTimer = 0;
        this.trailRadius = (config as any).trailRadius;
        this.trailDuration = (config as any).trailDuration;
        this.trailDamage = (config as any).trailDamage;
    ...
    update(dt: number, playerX: number, playerY: number, context: any = {}): FireTrailInfo | null {
        ...
        if (this.trailTimer >= this.trailInterval) {
            ...
            return {
                ...
                duration: this.trailDuration,
                damage: this.trailDamage,
                creator: this as any  // Track which enemy created this trail
            };
        }
