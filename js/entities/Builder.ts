...
export class Builder extends BaseEnemy {
    ...
    update(dt: number, playerX: number, playerY: number, context: BuilderContext = {}): FireTrailInfo | null {
        ...
        if (distToPlayer < this.fleeRadius) {
            ...
            let target: Crystal | SpawnBlock | null = null;
            let targetType: 'crystal' | 'tower' | null = null;
            ...
            if (target) {
                ...
                this.targetCrystal = targetType === 'crystal' ? target as Crystal : null;
                this.targetTower = targetType === 'tower' ? target as SpawnBlock : null;
